...
function Home({ user, onLogout }) {
  ...
  const [locations, setLocations] = useState([
    { 
      id: 1, 
      position: [-7.7901746261802005, 110.37523986883392], 
      name: 'Stasiun Lempuyangan', 
      code: 'LPN',
      type: 'green', 
      category: 'stasiun',
      totalPerangkat: 200,
      details: 'Stasiun utama di Yogyakarta'
    },
    { 
      id: 2, 
      position: [-7.788511764052999, 110.36355922009226], 
      name: 'Stasiun Tugu Yogyakarta', 
      code: 'YK',
      type: 'green', 
      category: 'stasiun',
      totalPerangkat: 250,
      details: 'Stasiun pusat Yogyakarta'
    },
    { 
      id: 3, 
      position: [-7.789865481584323, 110.37294325588496], 
      name: 'Kantor Daop 6 Yogyakarta', 
      type: 'red', 
      category: 'kantor',
      totalPerangkat: 120,
      details: 'Kantor Daerah Operasi 6'
    },
    { 
      id: 4, 
      position: [-7.7896870933157905, 110.37501517544246], 
      name: 'Gudang Logistik Yogyakarta', 
      type: 'red', 
      category: 'gudang',
      totalPerangkat: 85,
      details: 'Gudang penyimpanan logistik'
    },
    { 
      id: 5, 
      position: [-7.784584952949787, 110.43716400764015], 
      name: 'Stasiun Maguwo', 
      code: 'MGW',
      type: 'green', 
      category: 'stasiun',
      totalPerangkat: 95,
      details: 'Stasiun dekat bandara'
    },
    { 
      id: 6, 
      position: [-7.790327350892273, 110.37304393694306], 
      name: 'PJL Lempuyangan', 
      code: 'LPN-PJL',
      type: 'blue', 
      category: 'pjl',
      totalPerangkat: 60,
      details: 'Penjaga Jalan Lintasan'
    },
  ])
